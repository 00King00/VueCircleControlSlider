...
export default {
  ...
  created () {
    ...
    this.circleState = new CircleState(this.steps, this.value, this.radius, this.size/2)
  ...
  computed: {
    ...
    cpPathD () {
      return `M${this.cpCenter+this.radius} ${this.cpCenter} A ${this.radius} ${this.radius} 0 ${this.cpPathDirection} 1 ${this.cpPathX} ${this.cpPathY} `
    }
  },
  methods: {
